...
namespace Mixtri.Core.Media;

/// <summary>
/// Outcome of normalising an external video into Mixtri's working-media layout.
/// </summary>
/// <remarks>
...
/// <summary>
/// Normalises an external (not Mixtri-recorded) video into the working-media layout the
