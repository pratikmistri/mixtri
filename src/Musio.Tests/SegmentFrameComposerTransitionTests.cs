...
/// <see cref="Musio.Core.Timeline.TransitionResolution.OutgoingLocalOffset"/>) while never
...
/// (a video file, a <see cref="Musio.Core.Processing.VideoFrameReader"/>, etc.) to build a
