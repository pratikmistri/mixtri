...
public static class ProjectSaveCoordinator
{
    ...
    /// <summary>Shows the standard <c>.mixtri</c> save picker, returning null when cancelled.</summary>
    public static async Task<string?> PickSavePathAsync(string projectName, Window? window)
    {
        ...
        picker.FileTypeChoices.Add("Mixtri project", [MixtriPackage.FileExtension]);
