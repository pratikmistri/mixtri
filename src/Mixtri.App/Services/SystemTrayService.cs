...
/// <summary>
/// Manages a Win32 system tray icon with context menu for the Mixtri app.
...
public sealed class SystemTrayService : IDisposable
{
    ...
    private void CreateMessageWindow()
    {
        ...
        var wndClass = new WNDCLASS
        {
            ...
            hInstance = hInstance,
            lpszClassName = "MixtriTrayMsgWindow"
        };
    ...
    private void ShowContextMenu()
    {
        ...
        try
        {
            ...
            AppendMenu(hMenu, MF_STRING, IDM_OPEN_MINI, "Open Mixtri Mini");
            AppendMenu(hMenu, MF_STRING, IDM_OPEN, "Open Mixtri");
