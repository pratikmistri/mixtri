...
public sealed partial class EditorPage
{
    ...
    private async Task InitializePreviewAsync()
    {
        ...
        {
            Mixtri.Core.Diagnostics.DiagLog.Write("Editor", $"InitializePreview FAILED: {ex}");
        }
    }
    ...
    /// needing to call that helper -- which stayed <c>internal</c> to Mixtri.Core (only
    /// <c>Mixtri.Tests</c> has <c>InternalsVisibleTo</c>) even after the T8 integration pass,
