...
public sealed partial class EditorPage : Page
{
    ...
    // ─── Project package (.mixtri) save / open ───────────────────────────
    ...
    private async Task SaveProjectAsync(bool forcePrompt)
    {
        ...
        {
            Mixtri.Core.Diagnostics.DiagLog.Write("Editor", $"Project save failed: {ex}");
    ...
    private async Task<string?> PickSavePathAsync(string projectName)
    {
        ...
        {
            Mixtri.Core.Diagnostics.DiagLog.Write("Editor", $"Save picker failed: {ex.Message}");
            return null;
        }
    }
    ...
    public bool TryCloseProjectForShellDismissal()
    {
        ...
        Mixtri.Core.Diagnostics.DiagLog.Write("Editor", "project closed with the window");
        return true;
    }
    ...
    private async Task CloseProjectAsync()
    {
        ...
        ResetProjectToEmptyState();
        Mixtri.Core.Diagnostics.DiagLog.Write("Editor", "project closed; editor reset to empty state");
    }
