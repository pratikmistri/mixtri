...
public sealed class ZoomCameraPathTests
{
    ...
    /// <para>
    /// Regression from Sample7.mixtri, reported as "segment 1 is 2x and segment 2 is 1.5x...
    ...
    {
        // Exact values from Sample7.mixtri (source 2304x1536).
        const int w = 2304;
        const int h = 1536;
    ...
    /// <para>
    /// Regression from Sample9.mixtri: five overlapping auto segments, all 2×, produced four
    ...
    public void ChainOfEqualZoomSegments_HoldsThatZoomFlatThroughout()
    {
        ...
        // Sample9.mixtri: five auto clicks, all 2x, centres flung across opposite corners so any
    ...
    /// <para>
    /// Regression from Sample7.mixtri: "the transition to 1.5x happens when first segment is
