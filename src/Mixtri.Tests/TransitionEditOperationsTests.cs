...
/// <see cref="MixtriPackageService.SaveAsync"/> / <see cref="MixtriPackageService.OpenAsync"/>.
/// </summary>
/// <remarks>
...
public sealed class TransitionPackageRoundTripTests
{
    ...
    public void SetUp()
    {
        _tempDir = new TempDirectoryFixture("mixtri_transition_pkg_");
    ...
    public async Task SaveThenOpen_PreservesNullExplicitNoneAndConfigured_AsDistinctPerBoundaryStates()
    {
        ...
        var packagePath = Path.Combine(_root, "transitions.mixtri");
