...
- **Webcam** — Used to capture a webcam overlay during recordings, if you enable this option. Webcam video is saved locally as part of your recording.

These permissions are requested only when needed and can be revoked at any time through Windows Settings.
