...
- [x] **STAB-001: Stop swallowing every XAML unhandled exception**
  - **Evidence:** `src/Mixtri.App/App.xaml.cs:81-85`
...
- [x] **STAB-002: Bound webcam shutdown**
  - **Evidence:** `src/Mixtri.Core/Capture/RecordingSession.cs:329-330`,
    `src/Mixtri.Core/Capture/WebcamCaptureEngine.cs:83-92`
...
- [x] **STAB-003: Move JPEG encoding and disk writes off the capture callback**
  - **Evidence:** `src/Mixtri.Core/Capture/ScreenCaptureEngine.cs:164-225`,
    `src/Mixtri.Core/Capture/RecordingSession.cs:568-583`,
    `src/Mixtri.Core/Capture/VideoWriter.cs:157-214`
...
- [x] **STAB-004: Surface frame-write failures during recording**
  - **Evidence:** `src/Mixtri.Core/Capture/VideoWriter.cs:215-220`,
    `src/Mixtri.Core/Capture/VideoWriter.cs:608-610`,
    `src/Mixtri.Core/Capture/RecordingSession.cs:351-360`
...
- [x] **STAB-005: Release the raw Direct3D interop COM pointer**
  - **Evidence:** `src/Mixtri.Core/Capture/Direct3DDeviceHelper.cs:41-49`
...
- [x] **PERF-001: Stop redrawing every timeline track on each playhead tick**
  - **Evidence:** `src/Mixtri.App/Controls/TimelineControl.xaml.cs:515-523`,
    `src/Mixtri.App/Controls/TimelineControl.xaml.cs:337-346`
...
- [x] **PERF-002: Preload wallpaper images outside frame composition**
  - **Evidence:** `src/Mixtri.Core/Processing/BackgroundCompositor.cs:158-181`
...
- [ ] **PERF-003: Add a benchmarked capture-mode ladder**
  - **Evidence:** `learnings.md` section "Settings audit: recording FPS selector is not wired";
    `src/Mixtri.App/ViewModels/RecordingViewModel.cs:62`,
    `src/Mixtri.Core/Capture/VideoWriter.cs:157-214`
...
- [ ] **STAB-006: Make hook-thread teardown observable and recoverable**
  - **Evidence:** `src/Mixtri.Core/Capture/MouseHookRecorder.cs:208-225`,
    `src/Mixtri.Core/Capture/KeyboardHookRecorder.cs:169-180`
...
- [ ] **STAB-007: Replace fixed audio-stop sleep with callback drain completion**
  - **Evidence:** `src/Mixtri.Core/Capture/AudioCaptureEngine.cs:271-292`
...
- [ ] **STAB-008: Guard stats subscribers on the timer thread**
  - **Evidence:** `src/Mixtri.Core/Capture/RecordingSession.cs:598-619`
...
- [ ] **STAB-009: Give `PreviewCanvas` deterministic unload cleanup**
  - **Evidence:** `src/Mixtri.App/Controls/PreviewCanvas.xaml.cs:13-19`,
    `src/Mixtri.App/Controls/PreviewCanvas.xaml.cs:112-149`
...
- [ ] **STAB-010: Do not reserve global shortcuts that perform no action**
  - **Evidence:** `src/Mixtri.App/App.xaml.cs:574-586`,
    `src/Mixtri.App/App.xaml.cs:726-740`
  - Ctrl+Shift+R/P/S are registered globally, but every handler is a TODO/no-op. Mixtri can consume
...
- [ ] **STAB-011: Fix or quarantine the speech-to-text prototype**
  - **Evidence:** `src/Mixtri.Core/AI/SpeechToText.cs:99-125`; no production call sites
...
- [ ] **PERF-004: Parallelize Gallery card metadata and poster loading with a bound**
  - **Evidence:** `src/Mixtri.App/Pages/OpenProjectsPage.xaml.cs:68-92`
...
- [ ] **PERF-005: Cache stable background-composition resources**
  - **Evidence:** `src/Mixtri.Core/Processing/BackgroundCompositor.cs:199-268`
...
- [ ] **PERF-006: Pre-index and cache keyboard overlay display data**
  - **Evidence:** `src/Mixtri.Core/Processing/KeyboardOverlayRenderer.cs:62-119`,
    `src/Mixtri.Core/Processing/KeyboardOverlayRenderer.cs:172-221`
...
- [ ] **PERF-007: Cache subtitle lookup and layout**
  - **Evidence:** `src/Mixtri.Core/AI/SubtitleBurner.cs:59-104`
...
- [ ] **PERF-008: Avoid repeated camera-track scans per frame**
  - **Evidence:** `src/Mixtri.Core/Timeline/TimelineModel.cs:44-72`,
    `src/Mixtri.Core/Export/ExportEngine.cs:332-338`,
    `src/Mixtri.App/Pages/EditorPage.xaml.cs:1406-1415`
...
- [ ] **PERF-009: Reduce legacy JPEG fallback file-system probes**
  - **Evidence:** `src/Mixtri.Core/Processing/JpegFrameSource.cs:43-66`
...
- [ ] **PERF-010: Defer or incrementally schedule startup cleanup**
  - **Evidence:** `src/Mixtri.App/App.xaml.cs:500-510`,
    `src/Mixtri.Core/Services/SessionCleanupService.cs:156-244`
...
- [ ] **PERF-011: Bound long-recording cursor memory**
  - **Evidence:** `src/Mixtri.Core/Capture/MouseHookRecorder.cs:119,255-263,528-541`
...
- [ ] **DEAD-001: Remove the unused DPI heuristic**
  - **Evidence:** `src/Mixtri.Core/Processing/FrameCompositor.cs:256`; definition-only search result
...
- [ ] **DEAD-002: Decide whether `PerformanceMonitor` is product code or test-only code**
  - **Evidence:** `src/Mixtri.Core/Diagnostics/PerformanceMonitor.cs`; referenced only by
    `src/Mixtri.Tests/PerformanceMonitorTests.cs`
...
- [ ] **DEAD-003: Remove the placeholder empty test**
  - **Evidence:** `src/Mixtri.Tests/Test1.cs`
...
- [ ] **DEAD-004: Wire the Default FPS setting or remove it from Settings**
  - **Evidence:** `src/Mixtri.App/Pages/SettingsPage.xaml:86-92`,
    `src/Mixtri.Core/Settings/AppSettings.cs:36-39`,
    `src/Mixtri.App/ViewModels/RecordingViewModel.cs:62`
